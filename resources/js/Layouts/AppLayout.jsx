                ...
                <div className="container mx-auto max-w-screen-lg px-4 lg:px-10">
                    ...
                    <div className="mt-10 text-center">
                        ...
                        <p className="text-sm text-slate-500">
                            ...
                            <a href="/terms-and-conditions" className="text-teal-500 hover:text-teal-400 no-underline"> Terms & Conditions </a> 
                            · 
                            <a href="/privacy-policy" className="text-teal-500 hover:text-teal-400 no-underline"> Privacy Policy </a>
                        </p>
                    </div>
                </div>
            </footer>
